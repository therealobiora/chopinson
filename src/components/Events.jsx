...
const Events = () => {
  ...
  return (
    ...
    >
      <div className="container bg-[#f5f5f5] rounded-md h-[52vh] md:h-[50vh] mx-auto max-w-[95%] px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-8">
        <motion.div
