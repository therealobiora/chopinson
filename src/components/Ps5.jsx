...
const Ps5 = () => {
  ...
  const isInView = useInView(ps5Ref, { once: true, margin: "-100px" });
      ...
      <div className="container mx-auto max-w-[95%] h-[50vh] md:h-[50vh] bg-[#f5f5f5] rounded-md justify-center px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-6 sm:gap-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base font-medium md:text-lg text-gray-600">
            Take part in exciting PS5 competitions and win exciting prizes. Join
            our community and be a part of the PS5 revolution.Showcase your
            skills and compete with other gamers for the coveted PS5 trophy.
          </p>
        </motion.div>
      </div>
    </motion.section>
