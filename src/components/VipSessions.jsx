...
const VipSessions = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-[95%] h-[54vh] md:h-[50vh] bg-[#f5f5f5] rounded-md justify-center px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-6 sm:gap-8">
        <motion.div
